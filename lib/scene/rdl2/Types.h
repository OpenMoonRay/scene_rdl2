...
enum SceneObjectInterface : int {
    ...
    INTERFACE_DWABASE              = 1 << 17,
    INTERFACE_DWABASELAYERABLE     = 1 << 18,
    INTERFACE_DWABASEHAIRLAYERABLE = 1 << 19,
    INTERFACE_METADATA             = 1 << 20,
    INTERFACE_LIGHTFILTER          = 1 << 21,
    INTERFACE_TRACESET             = 1 << 22,
    INTERFACE_JOINT                = 1 << 23,
    INTERFACE_LIGHTFILTERSET       = 1 << 24,
    INTERFACE_SHADOWSET            = 1 << 25,
    INTERFACE_NORMALMAP            = 1 << 26,
    INTERFACE_DISPLAYFILTER        = 1 << 27,
    INTERFACE_SHADOWRECEIVERSET    = 1 << 28,
};
