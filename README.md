# scene_rdl2 - part of the [MoonRay](https://github.com/OpenMoonRay/openmoonray) project
...
This repository provides MoonRay’s scene representation and a number of utility libraries.
